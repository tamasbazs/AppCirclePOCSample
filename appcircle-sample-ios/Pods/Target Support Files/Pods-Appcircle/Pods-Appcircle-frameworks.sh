...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/googleapis.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/grpc.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/GRPCClient.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/MFSDKVoiceKit.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/nanopb.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/openssl.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/Protobuf.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/ProtoRPC.framework"
  install_framework "${PODS_ROOT}/MorfeusVoiceKit/RxLibrary.framework"
